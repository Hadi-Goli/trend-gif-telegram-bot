...
*   **ربات‌های پراکسی اختصاصی (Admin Proxy Bots)**: ادمین‌ها می‌توانند توکن ربات شخصی خودشان را در سیستم ثبت کنند تا گیف‌های نهایی با «امضای» ربات اختصاصی خودشان در کانال منتشر شود (به صورت خودکار و امن).
